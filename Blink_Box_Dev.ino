...
//Input for potentiometer to set NUM_LEDS
//const int pixelNumInPin = A9;
...
void loop()
{
 ...
 uint8_t outputValue = map(brightValue, 0, 1023, 5, 245);
    // now set the brightness of the strip
  FastLED.setBrightness(outputValue);
    // variable for screen
 uint8_t percentBrightness = map(outputValue, 0, 245, 9, 95);
  ...
  //display.println(String("Number of Pixels: ") +pixelNum);
